...
export type WorkOrderRecord = CommandRecord & {
  ...
  thirdCutDate?: string;
  rootPruneCycleId?: string;
  rootPruneTaskStatus?: string;
  rootPruneEventNumber?: string | number;
  recommendedRootPruningPeriodMonths?: string | number;
  monthsFromCycleStart?: string | number;
  plannedCutPercent?: string | number;
  actualCutPercent?: string | number;
  cumulativeCutPercentAfterEvent?: string | number;
  cutStageCompleted?: string | boolean;
  rootPruneMethod?: string;
  rootballSize?: string;
  rootballDepth?: string;
  utilityClearanceStatus?: string;
  locateTicket?: string;
  nutrientCareRequiredAfterEvent?: string | boolean;
  waterStarted?: string | boolean;
  photosRequired?: string | boolean;
  photosComplete?: string | boolean;
  moveTaskStatus?: string;
  moveType?: string;
  holdingAreaName?: string;
  operator?: string;
  accessConfirmed?: string | boolean;
  irrigationReady?: string | boolean;
  finalGradeReady?: string | boolean;
  treeSetComplete?: string | boolean;
  backfillComplete?: string | boolean;
  stakingGuyingComplete?: string | boolean;
  waterInComplete?: string | boolean;
  relatedRootPruningId?: string;
  carePhase?: string;
  careTaskStatus?: string;
  vendor?: string;
  treatmentRequired?: string | boolean;
  treatmentType?: string;
  treatmentProduct?: string;
  treatmentRate?: string | number;
  treatmentQuantity?: string | number;
  ...
  siltBuildupObserved?: string | boolean;
  drainageIssueObserved?: string | boolean;
...
export type TreeRelocationRecord = CommandRecord & {
  ...
  rootPruneRequired?: string | boolean;
  nutrientCareRequired?: string | boolean;
  relocationRequired?: string | boolean;
  installationRequired?: string | boolean;
  firstCutDate?: string;
  secondCutDate?: string;
