...
const fieldSets: Record<string, FieldConfig[]> = {
  ...
  document: [
    ...
    { key: 'category', label: 'Category', type: 'select', options: ['Permit', 'Bill of Lading', 'Proof of Delivery', 'Photo', 'Contract', 'Invoice', 'Other'] },
    { key: 'status', label: 'Status', type: 'select', options: ['Draft', 'Received', 'Filed', 'Needs Review', 'Approved'] },
  ...
  assign_work: [
    ...
    { key: 'scheduledDate', label: 'Scheduled Date', type: 'date', section: 'When' },
  ...
  assign_equipment: [
    ...
    { key: 'scheduledDate', label: 'Needed Date', type: 'date', section: 'Timing & Location' },
  ...
  assign_freight: [
    ...
    { key: 'scheduledDate', label: 'Needed Date', type: 'date', section: 'Timing' },
    { key: 'dueDate', label: 'Target Completion Date', type: 'date' },
    { key: 'status', label: 'Request Status', type: 'select', options: workOrderStatusOptions, defaultValue: 'Draft', section: 'Status & Notes' },
    { key: 'priority', label: 'Priority', type: 'select', options: workOrderPriorityOptions, defaultValue: 'Normal' },
