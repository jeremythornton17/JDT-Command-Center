           ...
           <div className="flex flex-wrap items-center justify-center md:justify-end gap-1.5 sm:gap-2">
             {type === 'job' && (
                <>
                  ...
                  <button onClick={() => openModal('delete_job', matchedJob)} className="px-3 py-2 sm:px-4 sm:py-2.5 text-[10px] sm:text-xs font-black uppercase rounded-lg bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 shadow-sm font-sans text-center transition-colors">Delete</button>
             ...
             {type === 'tree' && (
                <>
                  ...
                  <button onClick={() => openModal('delete_tree', matchedTree)} className="px-2.5 py-1.5 sm:px-3 sm:py-2 text-[10px] sm:text-[11px] font-black uppercase rounded-lg bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 shadow-sm transition-colors">Delete</button>
                  <button onClick={() => openModal('edit_tree', matchedTree)} className="px-2.5 py-1.5 sm:px-3 sm:py-2 text-[10px] sm:text-[11px] font-black uppercase rounded-lg border border-jdt-border bg-jdt-panel text-zinc-700 shadow-sm hover:bg-jdt-panel flex items-center justify-center gap-1"><Edit2 className="h-3 w-3 sm:h-3.5 sm:w-3.5" /> Edit</button>
             ...
             {type === 'freight' && (
                <>
                  ...
                  <button onClick={() => openModal('delete_freight', matchedFreight)} className="px-3 py-2 sm:px-4 sm:py-2.5 text-[10px] sm:text-xs font-black uppercase rounded-lg bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 shadow-sm font-sans text-center transition-colors">Delete</button>
             ...
             {type === 'equipment' && (
                <>
                  ...
                  <button onClick={() => openModal('delete_equipment', matchedEquipment)} className="px-2.5 py-1.5 sm:px-3 sm:py-2 text-[10px] sm:text-[11px] font-black uppercase rounded-lg bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 shadow-sm font-sans flex items-center justify-center transition-colors">Delete</button>
